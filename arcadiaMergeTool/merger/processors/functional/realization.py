...
@process.register
def _(
    x: mm.fa.FunctionalExchangeRealization,
    dest: CapellaMergeModel,
    src: CapellaMergeModel,
    base: CapellaMergeModel,
    mapping: MergerElementMappingMap,
) -> bool:
    """Find and merge Functional Exchange Realizations
    ...
    dest:
        Destination model to add Functional Exchange Realizations to
    src:
        Source model to take Functional Exchange Realizations from
    base:
        Base model to check Functional Exchange Realizations against
    mapping:
    ...
    if (isinstance(destParent, mm.fa.FunctionalExchange)
    ):
        targetCollection = destParent.functional_exchange_realizations
    else:
        LOGGER.fatal(
