"""Find and merge AbstractFunctionAbstractCapabilityInvolvement."""
...
T = mm.interaction.AbstractFunctionAbstractCapabilityInvolvement
...
def _(
    ...
    if isinstance(destParent, (mm.la.CapabilityRealization, mm.sa.Capability)):
        targetCollection = destParent.function_involvements
    else:
        return Fault
