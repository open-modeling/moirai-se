...
def _(
    ...
    if (isinstance(destParent, (mm.sa.SystemComponent, mm.pa.PhysicalComponent, mm.la.LogicalComponent))
    ):
        targetCollection = destParent.component_realizations # pyright: ignore[reportAttributeAccessIssue] except component_realization is a valid attribute
    else:
        return Fault
