"""Find and merge Boolean Property Values."""
...
def _(
    ...
    if (isinstance(destParent, (cc.PropertyValueGroup, cc.PropertyValuePkg, mm.capellacore.CapellaElement))
    ):
