...
from arcadiaMergeTool.merger.processors import capellacommon
...
def _(
    ...
    if (isinstance(destParent, (mm.capellacommon.StateMachine, mm.capellacommon.Region))):
        targetCollection = destParent.regions
    else:
        return Fault
